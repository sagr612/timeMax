...
export const ALL_AUCTION_PRODUCT_REQUEST = "ALL_AUCTION_PRODUCT_REQUEST";
export const ALL_AUCTION_PRODUCT_SUCCESS = "ALL_AUCTION_PRODUCT_SUCCESS";
export const ALL_AUCTION_PRODUCT_FAIL = "ALL_AUCTION_PRODUCT_FAIL";
...
export const ADMIN_AUCTION_PRODUCT_REQUEST = "ADMIN_AUCTION_PRODUCT_REQUEST";
export const ADMIN_AUCTION_PRODUCT_SUCCESS = "ADMIN_AUCTION_PRODUCT_SUCCESS";
export const ADMIN_AUCTION_PRODUCT_FAIL = "ADMIN_AUCTION_PRODUCT_FAIL";
...
export const AUCTION_PRODUCT_DETAILS_REQUEST =
  "AUCTION_PRODUCT_DETAILS_REQUEST";
export const AUCTION_PRODUCT_DETAILS_SUCCESS =
  "AUCTION_PRODUCT_DETAILS_SUCCESS";
export const AUCTION_PRODUCT_DETAILS_FAIL = "AUCTION_PRODUCT_DETAILS_FAIL";
